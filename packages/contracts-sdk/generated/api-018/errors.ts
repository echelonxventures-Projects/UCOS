 ...
 *
 * Error scaffold for API-018 (Configuration & Metadata API).
 *
...
/**
 * OPAQUE error type for API-018. The catalog declares NO error model (G5 / declared:false);
 * this alias is a placeholder until an error model is authored + ratified. Do NOT assume codes or shapes.
 */
export type Api018Error = OpaquePayload;
